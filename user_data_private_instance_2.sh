...
mysql -u testUser -ppassw0rd -e 'use test; insert into testtable values("1", "Vinya", "Somayajula");'
mysql -u testUser -ppassw0rd -e 'use test; insert into testtable values("2", "Deekshith Reddy", "Addela");'
...
echo "echo \"\n Connected with database 2\"; " >> /var/www/html/api/data.php
